...
## Fork of better-console as holos aspect, which will serve as any excursion into logging


`holodeck` (`better-console`) is a drop-in replacement for node's default console which gives you colors and more methods in console.
